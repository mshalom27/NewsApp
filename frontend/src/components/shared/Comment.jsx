...
const Comment = ({ comment, onLike, onEdit, onDelete }) => {
  ...
  useEffect(() => {
    const getUser = async () => {
      try {
        const res = await fetch(`https://newsapp-mwio.onrender.com/api/user/${comment.userId}`)
  ...
  const handleSave = async () => {
    try {
      const res = await fetch(`https://newsapp-mwio.onrender.com//api/comment/editComment/${comment._id}`, {
        method: "PUT",
        headers: {

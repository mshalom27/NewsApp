...
const DashboardProfile = () => {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const profilePictureUrl = storage.getFileView(
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://newsapp-mwio.onrender.com/api/user/update/${currentUser._id}`, {
        method: "PUT",
        headers: {
  ...
  const handleDeleteUser = async () => {
    try {
      ...
      const res = await fetch(`https://newsapp-mwio.onrender.com/api/user/delete/${currentUser._id}`, {
        method: "DELETE",
      })
  ...
  return (
    <div className="max-w-lg mx-auto p-6 w-full bg-amber-50 rounded-xl shadow-md border border-amber-200">
